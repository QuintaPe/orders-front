export default {
    ...
    changePasswordDescription: 'Aggiorna la password del tuo account per sicurezza',
    notificationSettings: 'Impostazioni Notifiche',
    notificationSettingsDescription: 'Configura come ricevi le notifiche',
    privacySettings: 'Impostazioni Privacy',
    privacySettingsDescription: 'Gestisci le tue preferenze di privacy',
    change: 'Cambia',
    configure: 'Configura',
    accessDenied: 'Accesso Negato',
    pleaseLoginToViewProfile: 'Effettua l\'accesso per visualizzare il tuo profilo',
    orders: 'Ordini',
    products: 'Prodotti',
    ...
    markAsPreparing: 'Segna come Preparazione',
